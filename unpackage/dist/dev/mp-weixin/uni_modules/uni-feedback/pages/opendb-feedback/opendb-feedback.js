...
if (!Array) {
  ...
  (_easycom_uni_forms_item2 + _easycom_uni_file_picker2 + _easycom_uni_easyinput2 + _easycom_uni_forms2 + _easycom_uni_fab2)();
}
...
if (!Math) {
  (_easycom_uni_forms_item + _easycom_uni_file_picker + _easycom_uni_easyinput + _easycom_uni_forms + _easycom_uni_fab)();
}
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    n: common_vendor.sr("form", "3c4e37f9-0"),
    o: common_vendor.p({
      value: $data.formData,
      ["validate-trigger"]: "submit",
      ["err-show-type"]: "toast"
    }),
    p: common_vendor.sr("fab", "3c4e37f9-8"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/Hbuilderx/quanzi_ketang/uni_modules/uni-feedback/pages/opendb-feedback/opendb-feedback.vue"]]);
