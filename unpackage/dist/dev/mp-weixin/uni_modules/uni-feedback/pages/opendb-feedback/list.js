...
const _sfc_main = {
  data() {
    return {
      collectionList: [
        db.collection("opendb-feedback").field("user_id,content,imgs,contact,mobile,_id").getTemp(),
        db.collection("uni-id-users").field("_id,nickname,username").getTemp()
      ],
      loadMore: {
        contentdown: "",
        contentrefresh: "",
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    a: common_vendor.w(({
      ...
      return common_vendor.e({
        ...
        d: common_vendor.f(data, (item, index, i1) => {
          return {
            a: common_vendor.t(item.user_id[0].username),
            b: common_vendor.t(item.content),
            c: index,
            d: common_vendor.o(($event) => $options.handleItemClick(item._id), index),
            e: "4ed174c2-2-" + i0 + "-" + i1 + "," + ("4ed174c2-1-" + i0)
          };
        }),
        e: common_vendor.p({
          showArrow: true,
        ...
        f: "4ed174c2-1-" + i0 + ",4ed174c2-0"
      } : {}, {
        c: data,
        g: "4ed174c2-3-" + i0 + ",4ed174c2-0",
        h: common_vendor.p({
    ...
    b: common_vendor.sr("udb", "4ed174c2-0"),
    c: common_vendor.p({
      collection: $data.collectionList
    }),
    d: common_vendor.sr("fab", "4ed174c2-4"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/Hbuilderx/quanzi_ketang/uni_modules/uni-feedback/pages/opendb-feedback/list.vue"]]);
