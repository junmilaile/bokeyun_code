...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    t: common_vendor.sr("shortCode", "1863219a-10,1863219a-9"),
    ...
    y: common_vendor.sr("agreements", "1863219a-11,1863219a-0"),
    z: common_vendor.p({
      scope: "register"
    }),
    ...
    E: common_vendor.sr("form", "1863219a-0"),
    F: common_vendor.p({
      value: $data.formData,
      rules: $data.rules,
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/Hbuilderx/quanzi_ketang/uni_modules/uni-id-pages/pages/register/register-by-email.vue"]]);
