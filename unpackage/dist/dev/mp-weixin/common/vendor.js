...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__F75EE6D",
    appName: "quanzi_ketang",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const pages = [
  ...
  {
    path: "pages/quanzi_aticle/add",
    style: {
      navigationBarTitleText: "新增"
    }
  },
  {
    path: "pages/quanzi_aticle/edit",
    style: {
      navigationBarTitleText: "编辑"
    }
  },
  {
    path: "pages/quanzi_aticle/list",
    style: {
      navigationBarTitleText: "列表"
    }
  },
  {
    path: "pages/quanzi_aticle/detail",
    style: {
...
const ts = !!pageJson.uniIdRouter;
const { loginPage: ns, routerNeedLogin: ss, resToLogin: rs, needLoginPage: is, notNeedLoginPage: os, loginPageInTabBar: as } = function({ pages: e2 = [], subPackages: n2 = [], uniIdRouter: s2 = {}, tabBar: r2 = {} } = pageJson) {
