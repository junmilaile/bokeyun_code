  ...
  data() {
    return {
      collectionList: [
        ...
        db.collection("quanzi_aticle").field("_id,title").getTemp()
      ],
      loadMore: {
        contentdown: "",
        contentrefresh: "",
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return common_vendor.e({
        ...
        d: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            d: "6c2fe0d2-2-" + i0 + "-" + i1 + "," + ("6c2fe0d2-1-" + i0)
          };
        }),
        e: common_vendor.p({
          showArrow: true,
        ...
        f: "6c2fe0d2-1-" + i0 + ",6c2fe0d2-0"
      } : {}, {
        c: data,
        g: "6c2fe0d2-3-" + i0 + ",6c2fe0d2-0",
        h: common_vendor.p({
    ...
    b: common_vendor.sr("udb", "6c2fe0d2-0"),
    c: common_vendor.p({
      orderby: "publish_date desc",
      collection: $data.collectionList,
      field: "article_id,publish_date"
    })
  };
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/Hbuilderx/quanzi_ketang/pages/quanzi_like/list.vue"]]);
