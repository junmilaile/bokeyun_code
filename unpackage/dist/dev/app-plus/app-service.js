...
`, "color: #ffffff; background: #3c9cff; padding:5px 0;", "color: #3c9cff;background: #ffffff; padding:5px 0;");
  ...
  const props$2 = {
    props: {
      ...
      isDot: {
        type: Boolean,
        default: props$3.badge.isDot
      },
      // 显示的内容
      value: {
        type: [Number, String],
        default: props$3.badge.value
      },
      // 显示的内容
      modelValue: {
        type: [Number, String],
        default: props$3.badge.modelValue
      },
      // 是否显示
      show: {
        type: Boolean,
        default: props$3.badge.show
      },
      // 最大值，超过最大值会显示 '{max}+'
      max: {
        type: [Number, String],
        default: props$3.badge.max
      },
      // 主题类型，error|warning|success|primary
      type: {
        type: String,
        default: props$3.badge.type
      },
      // 当数值为 0 时，是否展示 Badge
      showZero: {
        type: Boolean,
        default: props$3.badge.showZero
      },
      // 背景颜色，优先级比type高，如设置，type参数会失效
      bgColor: {
        type: [String, null],
        default: props$3.badge.bgColor
      },
      // 字体颜色
      color: {
        type: [String, null],
        default: props$3.badge.color
      },
      // 徽标形状，circle-四角均为圆角，horn-左下角为直角
      shape: {
        type: String,
        default: props$3.badge.shape
      },
      ...
      numberType: {
        type: String,
        default: props$3.badge.numberType
      },
      // 设置badge的位置偏移，格式为 [x, y]，也即设置的为top和right的值，absolute为true时有效
      offset: {
        type: Array,
        default: props$3.badge.offset
      },
      // 是否反转背景和字体颜色
      inverted: {
        type: Boolean,
        default: props$3.badge.inverted
      },
      // 是否绝对定位
      absolute: {
        type: Boolean,
        default: props$3.badge.absolute
      }
    }
  };
  const mpMixin = {};
  ...
  const __easycom_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$4], ["__scopeId", "data-v-06cca9b7"], ["__file", "D:/Hbuilderx/quanzi_ketang/uni_modules/uview-plus/components/u-badge/u-badge.vue"]]);
  const props$1 = {
    props: {
      // 滑块的移动过渡时间，单位ms
      duration: {
        type: Number,
        default: props$3.tabs.duration
      },
      // tabs标签数组
      list: {
        type: Array,
        default: props$3.tabs.list
      },
      // 滑块颜色
      lineColor: {
        type: String,
        default: props$3.tabs.lineColor
      },
      // 菜单选择中时的样式
      activeStyle: {
        type: [String, Object],
        default: props$3.tabs.activeStyle
      },
      // 菜单非选中时的样式
      inactiveStyle: {
        type: [String, Object],
        default: props$3.tabs.inactiveStyle
      },
      // 滑块长度
      lineWidth: {
        type: [String, Number],
        default: props$3.tabs.lineWidth
      },
      // 滑块高度
      lineHeight: {
        type: [String, Number],
        default: props$3.tabs.lineHeight
      },
      // 滑块背景显示大小，当滑块背景设置为图片时使用
      lineBgSize: {
        type: String,
        default: props$3.tabs.lineBgSize
      },
      // 菜单item的样式
      itemStyle: {
        type: [String, Object],
        default: props$3.tabs.itemStyle
      },
      // 菜单是否可滚动
      scrollable: {
        type: Boolean,
        default: props$3.tabs.scrollable
      },
      // 当前选中标签的索引
      current: {
        type: [Number, String],
        default: props$3.tabs.current
      },
      // 默认读取的键名
      keyName: {
        type: String,
        default: props$3.tabs.keyName
      }
    }
  };
  const _sfc_main$5 = {
  ...
  const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$3], ["__scopeId", "data-v-02b0c54f"], ["__file", "D:/Hbuilderx/quanzi_ketang/uni_modules/uview-plus/components/u-tabs/u-tabs.vue"]]);
  const props = {
    props: {
      // 是否展示骨架组件
      loading: {
        type: Boolean,
        default: props$3.skeleton.loading
      },
      // 是否开启动画效果
      animate: {
        type: Boolean,
        default: props$3.skeleton.animate
      },
      // 段落占位图行数
      rows: {
        type: [String, Number],
        default: props$3.skeleton.rows
      },
      // 段落占位图的宽度
      rowsWidth: {
        type: [String, Number, Array],
        default: props$3.skeleton.rowsWidth
      },
      // 段落占位图的高度
      rowsHeight: {
        type: [String, Number, Array],
        default: props$3.skeleton.rowsHeight
      },
      // 是否展示标题占位图
      title: {
        type: Boolean,
        default: props$3.skeleton.title
      },
      // 段落标题的宽度
      titleWidth: {
        type: [String, Number],
        default: props$3.skeleton.titleWidth
      },
      // 段落标题的高度
      titleHeight: {
        type: [String, Number],
        default: props$3.skeleton.titleHeight
      },
      // 是否展示头像占位图
      avatar: {
        type: Boolean,
        default: props$3.skeleton.avatar
      },
      // 头像占位图大小
      avatarSize: {
        type: [String, Number],
        default: props$3.skeleton.avatarSize
      },
      // 头像占位图的形状，circle-圆形，square-方形
      avatarShape: {
        type: String,
        default: props$3.skeleton.avatarShape
      }
    }
  };
  const _sfc_main$4 = {
  ...
  const __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$2], ["__scopeId", "data-v-b376446f"], ["__file", "D:/Hbuilderx/quanzi_ketang/uni_modules/uview-plus/components/u-skeleton/u-skeleton.vue"]]);
  const _sfc_main$3 = {};
  function _sfc_render$1(_ctx, _cache) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "blogitem" }, " 博客 ");
  }
  const __easycom_2 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$1], ["__file", "D:/Hbuilderx/quanzi_ketang/components/blog-item/blog-item.vue"]]);
  const _sfc_main$2 = {
    __name: "index",
    setup(__props) {
      ...
      const dataList = vue.ref([1, 2, 3]);
      const loadState = vue.ref(false);
      const clickNav = (e) => {
        formatAppLog("log", "at pages/index/index.vue:54", e);
      };
      return (_ctx, _cache) => {
        const _component_u_tabs = resolveEasycom(vue.resolveDynamicComponent("u-tabs"), __easycom_0);
        const _component_u_skeleton = resolveEasycom(vue.resolveDynamicComponent("u-skeleton"), __easycom_1);
        const _component_blog_item = resolveEasycom(vue.resolveDynamicComponent("blog-item"), __easycom_2);
            ...
            (vue.openBlock(true), vue.createElementBlock(
              ...
              vue.renderList(dataList.value, (item) => {
                return vue.openBlock(), vue.createElementBlock("view", { class: "item" }, [
                  vue.createVNode(_component_blog_item)
                ]);
              }),
              256
              /* UNKEYED_FRAGMENT */
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-1cf27b2a"], ["__file", "D:/Hbuilderx/quanzi_ketang/pages/index/index.vue"]]);
  const _sfc_main$1 = {
    data() {
      return {};
    },
  ...
  const PagesSelfSelf = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__file", "D:/Hbuilderx/quanzi_ketang/pages/self/self.vue"]]);
  ...
  const b = true, k = "app", T = S([]), P = k, A = S('{\n    "address": [\n        "127.0.0.1",\n        "192.168.75.1",\n        "192.168.132.1",\n        "192.168.245.73"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/Hbuilderx/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), E = S('[{"provider":"aliyun","spaceName":"unl-node-demo","spaceId":"mp-edf44a31-f322-4c13-a898-9fb7a6ef6b11","clientSecret":"xvIMROKCfRz/zEnrmOGU3A==","endpoint":"https://api.next.bspapp.com"}]') || [];
  let x = "";
  try {
    x = "__UNI__F75EE6D";
  } catch (e) {
